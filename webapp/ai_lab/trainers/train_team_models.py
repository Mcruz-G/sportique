...
from utils import get_team_data, fit_data, save_model, log

def train_team_model(model_name, team):
    ...
    data = get_team_data(game_ids,team)
    model = fit_data(model, data)
    save_model(model, model_dir)
    log(game_ids, model_dir, model_name)

if __name__ == "__main__":
    train_team_model("HomeTeamModel", team="home")
    train_team_model("AwayTeamModel", team="away")